...
const getVehicleById = asyncHandler(async(req,res)=> {
    ...
    if(!id) {
        return res.status(400).json(
            new ApiResponse(400, null, "Vehicle ID is required")
        );
    }
...
// ye optional hai hum already driver ko vechicle se assign ker rhe cretae vechike controller mein 
// to abhi iski need nhi hai 
